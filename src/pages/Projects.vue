<template>
  <Layout>
    ...
    <h2 class="mb-4">I love to build things I can use everyday.</h2>
    ...
    <br>
    <h2 class="mb-4">I enjoy automating processes and improving workflows.</h2>
    ...
    <br>
    <h2 class="mb-4">I like tackling complex problems.</h2>
    ...
    <br>
    <h2 class="mb-4">What I'm working on now</h2>
